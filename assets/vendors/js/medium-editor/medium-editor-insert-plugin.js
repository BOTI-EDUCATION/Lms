...
(function (factory) {
    ...
    ; (function ($, window, document, undefined) {
        ...
        var pluginName = 'mediumInsert',
            ...
            defaults = {
                ...
                oembedProxy: app.url.base + "frame-youtube",
                captions: true,
    ...
    ; (function ($, window, document, Util, undefined) {
        ...
        Images.prototype.events = function () {
            ...
            this.$el
                .on('click', '.medium-insert-images iframe', $.proxy(this, 'selectImage'));
            $(window)
                .on('resize', $.proxy(this, 'autoRepositionToolbars'));
        };
        ...
        Images.prototype.deleteFile = function (file) {
            if (this.options.deleteScript) {
                $.ajax($.extend(true, {}, {
                    url: this.options.deleteScript + '?file=' + file.slice(file.lastIndexOf('/') + 1),
