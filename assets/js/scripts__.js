...
//         formData.append('father-nom', $('#' + id + '-father-nom').val())
//         formData.append('father-prenom', $('#' + id + '-father-prenom').val())
//         formData.append('father-email', $('#' + id + '-father-email').val())
//         formData.append('father-tel', $('#' + id + '-father-tel').val())
//     }

//     motherId = $_this.data('mother')
//     if (motherId) {
//         formData.append('mother', motherId)
//         formData.append('mother-nom', $('#' + id + '-mother-nom').val())
//         formData.append('mother-prenom', $('#' + id + '-mother-prenom').val())
//         formData.append('mother-email', $('#' + id + '-mother-email').val())
//         formData.append('mother-tel', $('#' + id + '-mother-tel').val())
//     }
    ...
    .each(function () {
        ...
        $this.select2({
            ...
            templateResult: function (data) {
                return $(data.element).data("html") || $(data.element).text();
            },
