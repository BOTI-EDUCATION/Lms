        ...
        <div class="card card-custom gutter-b">
          <div class="card-header">
            <div class="card-title">
              <h3 class="card-label">Composantes</h3>
            </div>
          </div>
      ...
      <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 v-if="!unite.value" class="modal-title" id="exampleModalLabel">
              Ajouter un type
            </h5>
            <h5 v-if="unite.value" class="modal-title" id="exampleModalLabel">
              Modifier un type
  ...
  methods: {
    ...
    getUnitesLength() {
      axios
        .get("/getUnitesLength")
        .then((response) => {
          this.unitesLength = response.data.unitesCount;
        })
        .catch((error) => {
          console.log(error);
        });
    ...
    onImageChange(e) {
      ...
      this.unite.image_url = "";
      this.unite.icon = e.target.files[0];
    },
    // get all unites
    getAllUnites() {
      axios
              ...
              axios
                ...
                .then((response) => {
                  if (response.data == "can't delete this item") {
                    ...
                    swal.fire(
                      "Deleted!",
                      "Your composante has been deleted.",
                      "success"
                    );
                  }
                  this.getUnitesLength();
    ...
    saveUnite(e) {
      ...
      $.each(this.unite, function(key, value) {
      ...
      axios
        .post("/updateUnite", formData, config)
        .then((response) => {
          this.clearForm();
          $("#modal_form_rubrique").modal("toggle");
