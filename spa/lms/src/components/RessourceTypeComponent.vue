    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
      ...
      >
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
          <!--begin::Page Title-->
          <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5" v-show="false">
            Types de ressources
          </h5>
          <div class="d-flex align-items-center" id="kt_subheader_search">
            <span class="text-dark-50 font-weight-bold" id="kt_subheader_total"
              >{{ rubriques.length }} Types de ressources</span
            >
            <form class="ml-5">
              <div
        ...
        <div class="card card-custom gutter-b">
          <div class="card-header">
            <div class="card-title">
              <h3 class="card-label">Types de ressources</h3>
            </div>
          </div>
            ...
            <v-card style="box-shadow: none;">
              ...
              >
                ...
                <template v-slot:item.actions="{ item }">
                  ...
                  <a
                    href="#"
                    class="btn btn-icon btn-light btn-hover-primary btn-sm d-none"
                  >
                    <span class="svg-icon svg-icon-md svg-icon-primary">
