        ...
        <div class="navi navi-spacer-x-0 p-0 d-none">
          ...
          <router-link to="/profile" class="navi-item">
            <div class="navi-link">
              ...
              <div class="navi-text">
                <div class="font-weight-bold">Editer mon profile</div>
          ...
          <!--end:Item-->
          <!--begin::Item-->
          <router-link to="/profile?password=password" class="navi-item">
            <div class="navi-link">
              <div class="symbol symbol-40 bg-light mr-3">
                <div class="symbol-label">
              ...
              <div class="navi-text">
                ...
                <div class="text-muted">Changer mon mot de passe</div>
              </div>
            </div>
          </router-link>
          <!--end:Item-->
