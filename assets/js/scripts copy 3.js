    ...
    addons: {
      ...
      images: {
        ...
        fileUploadOptions: {
          ...
          url: app.url.base + "upload-editor.php",
          acceptFileTypes: /(\.|\/)(gif|jpe?g|png|mp4)$/i, // (regexp) Regexp of accepted file types
        },
        styles: {
        ...
        uploadCompleted: function ($el, data) {
          ...
          if (file.type == 'video/mp4') {
            ...
            $el.html('<iframe src="' + file.url + '" style="width: auto;height: auto;" allowfullscreen="" scrolling="no" allow="accelerometer *; clipboard-write *; encrypted-media *; gyroscope *; picture-in-picture *;" class="medium-insert-image-active"></iframe>');
          }
        },
      },
    },
